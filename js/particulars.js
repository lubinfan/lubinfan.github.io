	  ...
	  for (var i=1;i<data[idSerial].contents.length;i++) { //第二个内容区域 	
         var cycle=''
          ...
          cycle +='<div style="text-align: center;"><img src="'+data[idSerial].contents[i].images[k].uri+'" class="particulars-img" /></div>'
			          +'</div><div style="height: 18px;text-align: center;"></div><p class="particulars-font"><font class="particulars-bold">'+data[idSerial].contents[i].images[k].Figure+': </font><span>'+data[idSerial].contents[i].images[k].caption+'</span></p>'
